          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-xs text-emerald-200/80 leading-relaxed max-w-sm">
                Masjid Raya Puri Telukjambe di bawah pengelolaan Yayasan Dewan
                Kemakmuran Masjid (DKM). Kompleks terintegrasi Dakwah, Sosial,
                Pendidikan, & Pemberdayaan Ekonomi Syariah.
              </p>
            ...
            <div className="space-y-3 bg-emerald-900/35 border border-emerald-800/40 p-4 rounded-2xl">
              ...
              <p className="text-xs text-emerald-200/70 leading-relaxed">
                Akses dashboard internal untuk pengurus DKM: kelola artikel,
                jadwal kajian, booking aula, dan laporan keuangan masjid.
              </p>
              <Link
                href="/login"
                className="inline-block w-full text-center text-[14px] text-amber-400 font-bold border border-amber-400 hover:bg-amber-400 hover:text-emerald-900 transition-colors duration-300 p-2 rounded"
              >
            ...
            <div className="space-y-3 bg-emerald-900/35 border border-emerald-800/40 p-4 rounded-2xl">
              <h4 className="text-xs font-bold uppercase tracking-wider text-amber-400">
                Sekretariat menerima saran dan masukan
              </h4>
              <p className="text-xs text-emerald-200/70 leading-relaxed">
                Kantor sekertariat DKM Masjid Raya Puri Telukjambe menerima
                saran dan masukan untuk perkembangan terbaik masjid tiap hari
                kerja pukul 08:30 - 16:30 WIB.
              </p>
              <a
